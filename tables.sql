...
create or replace function get_differences_cumulative(start_date timestamp without time zone, end_date timestamp without time zone, user_id integer, category_id integer DEFAULT NULL::integer)
